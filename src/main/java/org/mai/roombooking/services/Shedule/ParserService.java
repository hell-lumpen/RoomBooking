...
//
//
//   private @NonNull List<PageParser.ScheduleLesson> parseWebSite(@NonNull List<Group> groups) {
//        List<PageParser.ScheduleLesson> result = new LinkedList<>();
//        ConcurrentLinkedQueue<ParsingError> errors = new ConcurrentLinkedQueue<>();
//
////        // Парсинг
////        var parser = new PageParser(errors);
